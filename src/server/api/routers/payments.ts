...
import type { Address, CashPaymentDetails, Currency, CustomerDetails, ExternalPaymentDetails, OfflinePaymentDetails, Payment } from "node_modules/square/api";
...
export const paymentsRouter = createTRPCRouter({
    listPayments: publicProcedure
        .input(
            z.object({
                ...
                sortField: z.enum(["CREATED_AT", "OFFLINE_CREATED_AT", "UPDATED_AT"]).default("CREATED_AT"),
            })
        ).query(async ({ input }) => {
    ...
    createPayment: publicProcedure
        .input(
            ...
            if (response.payment === undefined) {
                throw Error("createPayment returned an undefined payment. This should not happen.");
            }
    ...
    getPayment: publicProcedure
        .input(
            ...
            if (response.payment === undefined) {
                throw Error("getPayment returned an undefined payment. This should not happen.");
            }
    ...
    updatePayment: publicProcedure
        .input(
            ...
            if (response.payment === undefined) {
                throw Error("updatePayment returned an undefined payment. This should not happen.");
            }
    ...
    cancelPayment: publicProcedure
        .input(
            ...
            if (response.payment === undefined) {
                throw Error("cancelPayment returned an undefined payment. This should not happen.");
            }
    ...
    completePayment: publicProcedure
        .input(
            ...
            if (response.payment === undefined) {
                throw Error("completePayment returned an undefined payment. This should not happen.");
            }
