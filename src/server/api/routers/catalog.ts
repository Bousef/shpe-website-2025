...
export const catalogRouter = createTRPCRouter({
    ...
    batchRetrieveCatalogObjects: publicProcedure
        .input(
    ...
    batchUpsertCatalogObjects: publicProcedure
        .input(
    ...
    updateCatalogImage: publicProcedure
        .input(
    ...
    upsertCatalogObject: publicProcedure
        .input(
    ...
    deleteCatalogObject: publicProcedure
        .input(
    ...
    retrieveCatalogObject: publicProcedure
        .input(
    ...
    searchCatalogObjects: publicProcedure
        .input(
    ...
    updateItemModifierLists: publicProcedure
        .input(
    ...
    //-- This endpoint is used to update item modifier lists in the catalog.
    updateItemTaxes: publicProcedure
        .input(
